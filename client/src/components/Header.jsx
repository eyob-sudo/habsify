    ...
    <header className="w-full bg-white border-b border-gray-100 px-6 py-4 fixed top-0 left-0 right-0 z-50">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <h1 className="text-2xl font-['Roboto'] font-black text-primary tracking-wide hover:scale-105 transition-transform duration-200 cursor-pointer">
            Habsify
          </h1>
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          >
            <i className="ri-task-line ri-lg" />
          </Link>

          <Link
            to="/notifications"
            className="w-10 h-10 bg-gray-100 text-gray-600 rounded-full flex items-center justify-center hover:bg-gray-200 transition-colors relative"
          >
            <i className="ri-notification-3-line ri-lg" />
            {unreadCount > 0 && (
          ...
          <div className="relative">
            ...
            <div
              ref={dropdownRef}
              className={`absolute right-0 top-12 w-48 bg-white rounded-lg shadow-lg border border-gray-100 py-2 z-50 transform transition-all duration-200 ${
